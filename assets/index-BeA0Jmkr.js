 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function De(){return typeof navigator<"u"&&typeof navigator.userAgent=="string"?navigator.userAgent:""}function Pf(){return typeof window<"u"&&!!(window.cordova||window.phonegap||window.PhoneGap)&&/ios|iphone|ipod|ipad|android|blackberry|iemobile/i.test(De())}function xf(){var e;const n=(e=Ws())==null?void 0:e.forceEnvironment;if(n==="node")return!0;if(n==="browser")return!1;try{return Object.prototype.toString.call(global.process)==="[object process]"}catch{return!1}}function kf(){return typeof navigator<"u"&&navigator.userAgent==="Cloudflare-Workers"}function Df(){const n=typeof chrome=="object"?chrome.runtime:typeof browser=="object"?browser.runtime:void 0;return typeof n=="object"&&n.id!==void 0}function Vf(){return typeof navigator=="object"&&navigator.product==="ReactNative"}function Lf(){const n=De();return n.indexOf("MSIE ")>=0||n.indexOf("Trident/")>=0}function Mf(){return!xf()&&!!navigator.userAgent&&navigator.userAgent.includes("Safari")&&!navigator.userAgent.includes("Chrome")}function Nf(){try{return typeof indexedDB=="object"}catch{return!1}}function Of(){return new Promise((n,e)=>{try{let t=!0;const r="validate-browser-context-for-indexeddb-analytics-module",s=self.indexedDB.open(r);s.onsuccess=()=>{s.result.close(),t||self.indexedDB.deleteDatabase(r),n(!0)},s.onupgradeneeded=()=>{t=!1},s.onerror=()=>{var i;e(((i=s.error)==null?void 0:i.message)||"")}}catch(t){e(t)}})}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Mn=Fm;function hu(n,e={}){let t=n;typeof e!="object"&&(e={name:e});const r={name:to,automaticDataCollectionEnabled:!0,...e},s=r.name;if(typeof s!="string"||!s)throw xt.create("bad-app-name",{appName:String(s)});if(t||(t=au()),!t)throw xt.create("no-options");const i=Ss.get(s);if(i){if(tn(t,i.options)&&tn(r,i.config))return i;throw xt.create("duplicate-app",{appName:s})}const a=new Kf(s);for(const u of no.values())a.addComponent(u);const c=new jm(t,r,a);return Ss.set(s,c),c}function fu(n=to){const e=Ss.get(n);if(!e&&n===to&&au())return hu();if(!e)throw xt.create("no-app",{appName:n});return e}function kt(n,e,t){let r=$m[n]??n;t&&(r+=`-${t}`);const s=r.match(/\s|\//),i=e.match(/\s|\//);if(s||i){const a=[`Unable to register library "${r}" with version "${e}":`];s&&a.push(`library name "${r}" contains illegal characters (whitespace or "/")`),s&&i&&a.push("and"),i&&a.push(`version name "${e}" contains illegal characters (whitespace or "/")`),ht.warn(a.join(" "));return}Rn(new nn(`${r}-version`,()=>({library:r,version:e}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class bu{constructor(e,t){this.user=t,this.type="OAuth",this.headers=new Map,this.headers.set("Authorization",`Bearer ${e}`)}}class np{getToken(){return Promise.resolve(null)}invalidateToken(){}start(e,t){e.enqueueRetryable(()=>t(xe.UNAUTHENTICATED))}shutdown(){}}class rp{constructor(e){this.token=e,this.changeListener=null}getToken(){return Promise.resolve(this.token)}invalidateToken(){}start(e,t){this.changeListener=t,e.enqueueRetryable(()=>t(this.token.user))}shutdown(){this.changeListener=null}}class sp{constructor(e){this.t=e,this.currentUser=xe.UNAUTHENTICATED,this.i=0,this.forceRefresh=!1,this.auth=null}start(e,t){re(this.o===void 0,42304);let r=this.i;const s=u=>this.i!==r?(r=this.i,t(u)):Promise.resolve();let i=new Vt;this.o=()=>{this.i++,this.currentUser=this.u(),i.resolve(),i=new Vt,e.enqueueRetryable(()=>s(this.currentUser))};const a=()=>{const u=i;e.enqueueRetryable(async()=>{await u.promise,await s(this.currentUser)})},c=u=>{$("FirebaseAuthCredentialsProvider","Auth detected"),this.auth=u,this.o&&(this.auth.addAuthTokenListener(this.o),a())};this.t.onInit(u=>c(u)),setTimeout(()=>{if(!this.auth){const u=this.t.getImmediate({optional:!0});u?c(u):($("FirebaseAuthCredentialsProvider","Auth not yet detected"),i.resolve(),i=new Vt)}},0),a()}getToken(){const e=this.i,t=this.forceRefresh;return this.forceRefresh=!1,this.auth?this.auth.getToken(t).then(r=>this.i!==e?($("FirebaseAuthCredentialsProvider","getToken aborted due to token change."),this.getToken()):r?(re(typeof r.accessToken=="string",31837,{l:r}),new bu(r.accessToken,this.currentUser)):null):Promise.resolve(null)}invalidateToken(){this.forceRefresh=!0}shutdown(){this.auth&&this.o&&this.auth.removeAuthTokenListener(this.o),this.o=void 0}u(){const e=this.auth&&this.auth.getUid();return re(e===null||typeof e=="string",2055,{h:e}),new xe(e)}}class ip{constructor(e,t,r){this.P=e,this.T=t,this.I=r,this.type="FirstParty",this.user=xe.FIRST_PARTY,this.R=new Map}A(){return this.I?this.I():null}get headers(){this.R.set("X-Goog-AuthUser",this.P);const e=this.A();return e&&this.R.set("Authorization",e),this.T&&this.R.set("X-Goog-Iam-Authorization-Token",this.T),this.R}}class op{constructor(e,t,r){this.P=e,this.T=t,this.I=r}getToken(){return Promise.resolve(new ip(this.P,this.T,this.I))}start(e,t){e.enqueueRetryable(()=>t(xe.FIRST_PARTY))}shutdown(){}invalidateToken(){}}class Nc{constructor(e){this.value=e,this.type="AppCheck",this.headers=new Map,e&&e.length>0&&this.headers.set("x-firebase-appcheck",this.value)}}class ap{constructor(e,t){this.V=t,this.forceRefresh=!1,this.appCheck=null,this.m=null,this.p=null,Ue(e)&&e.settings.appCheckToken&&(this.p=e.settings.appCheckToken)}start(e,t){re(this.o===void 0,3512);const r=i=>{i.error!=null&&$("FirebaseAppCheckTokenProvider",`Error getting App Check token; using placeholder token instead. Error: ${i.error.message}`);const a=i.token!==this.m;return this.m=i.token,$("FirebaseAppCheckTokenProvider",`Received ${a?"new":"existing"} token.`),a?t(i.token):Promise.resolve()};this.o=i=>{e.enqueueRetryable(()=>r(i))};const s=i=>{$("FirebaseAppCheckTokenProvider","AppCheck detected"),this.appCheck=i,this.o&&this.appCheck.addTokenListener(this.o)};this.V.onInit(i=>s(i)),setTimeout(()=>{if(!this.appCheck){const i=this.V.getImmediate({optional:!0});i?s(i):$("FirebaseAppCheckTokenProvider","AppCheck not yet detected")}},0)}getToken(){if(this.p)return Promise.resolve(new Nc(this.p));const e=this.forceRefresh;return this.forceRefresh=!1,this.appCheck?this.appCheck.getToken(e).then(t=>t?(re(typeof t.token=="string",44558,{tokenResult:t}),this.m=t.token,new Nc(t.token)):null):Promise.resolve(null)}invalidateToken(){this.forceRefresh=!0}shutdown(){this.appCheck&&this.o&&this.appCheck.removeTokenListener(this.o),this.o=void 0}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ru="server_timestamp",Pu="__type__",xu="__previous_value__",ku="__local_write_time__";function Lo(n){var t,r;return((r=(((t=n==null?void 0:n.mapValue)==null?void 0:t.fields)||{})[Pu])==null?void 0:r.stringValue)===Ru}function Qs(n){const e=n.mapValue.fields[xu];return Lo(e)?Qs(e):e}function Er(n){const e=Nt(n.mapValue.fields[ku].timestampValue);return new oe(e.seconds,e.nanos)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Be{constructor(e){this.value=e}static empty(){return new Be({mapValue:{}})}field(e){if(e.isEmpty())return this.value;{let t=this.value;for(let r=0;r<e.length-1;++r)if(t=(t.mapValue.fields||{})[e.get(r)],!ps(t))return null;return t=(t.mapValue.fields||{})[e.lastSegment()],t||null}}set(e,t){this.getFieldsMap(e.popLast())[e.lastSegment()]=fr(t)}setAll(e){let t=Ie.emptyPath(),r={},s=[];e.forEach((a,c)=>{if(!t.isImmediateParentOf(c)){const u=this.getFieldsMap(t);this.applyChanges(u,r,s),r={},s=[],t=c.popLast()}a?r[c.lastSegment()]=fr(a):s.push(c.lastSegment())});const i=this.getFieldsMap(t);this.applyChanges(i,r,s)}delete(e){const t=this.field(e.popLast());ps(t)&&t.mapValue.fields&&delete t.mapValue.fields[e.lastSegment()]}isEqual(e){return st(this.value,e.value)}getFieldsMap(e){let t=this.value;t.mapValue.fields||(t.mapValue={fields:{}});for(let r=0;r<e.length;++r){let s=t.mapValue.fields[e.get(r)];ps(s)&&s.mapValue.fields||(s={mapValue:{fields:{}}},t.mapValue.fields[e.get(r)]=s),t=s}return t.mapValue.fields}applyChanges(e,t,r){cn(t,(s,i)=>e[s]=i);for(const s of r)delete e[s]}clone(){return new Be(fr(this.value))}}function Mu(n){const e=[];return cn(n.fields,(t,r)=>{const s=new Ie([t]);if(ps(r)){const i=Mu(r.mapValue).fields;if(i.length===0)e.push(s);else for(const a of i)e.push(s.child(a))}else e.push(s)}),new ze(e)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ds{constructor(e,t="asc"){this.field=e,this.dir=t}}function Pp(n,e){return n.dir===e.dir&&n.field.isEqual(e.field)}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ti(n,e){if(n.useProto3Json){if(isNaN(e))return{doubleValue:"NaN"};if(e===1/0)return{doubleValue:"Infinity"};if(e===-1/0)return{doubleValue:"-Infinity"}}return{doubleValue:Rs(e)?"-0":e}}function Fo(n){return{integerValue:""+n}}function Qp(n,e){return Ep(e)?Fo(e):ti(n,e)}/**
 * @license
 * Copyright 2018 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ni{constructor(){this._=void 0}}function Jp(n,e,t){return n instanceof Ir?function(s,i){const a={fields:{[Pu]:{stringValue:Ru},[ku]:{timestampValue:{seconds:s.seconds,nanos:s.nanoseconds}}}};return i&&Lo(i)&&(i=Qs(i)),i&&(a.fields[xu]=i),{mapValue:a}}(t,e):n instanceof Ar?Ku(n,e):n instanceof Cr?Yu(n,e):n instanceof Sr?function(s,i){const a=Wu(s,i),c=Ms(a)+Ms(s.Ae);return br(a)&&br(s.Ae)?Fo(c):ti(s.serializer,c)}(n,e):n instanceof Vs?function(s,i){return Xc(s,i,Math.min)}(n,e):n instanceof Ls?function(s,i){return Xc(s,i,Math.max)}(n,e):void 0}function Xp(n,e,t){return n instanceof Ar?Ku(n,e):n instanceof Cr?Yu(n,e):t}function Wu(n,e){return n instanceof Sr?Lu(e)?e:{integerValue:0}:null}class Ir extends ni{}class Ar extends ni{constructor(e){super(),this.elements=e}}function Ku(n,e){const t=Qu(e);for(const r of n.elements)t.some(s=>st(s,r))||t.push(r);return{arrayValue:{values:t}}}class Cr extends ni{constructor(e){super(),this.elements=e}}function Yu(n,e){let t=Qu(e);for(const r of n.elements)t=t.filter(s=>!st(s,r));return{arrayValue:{values:t}}}class $o extends ni{constructor(e,t){super(),this.serializer=e,this.Ae=t}}class Sr extends $o{}class Vs extends $o{}class Ls extends $o{}function Xc(n,e,t){if(!Lu(e))return n.Ae;const r=t(Ms(e),Ms(n.Ae));return br(e)&&br(n.Ae)?Fo(r):ti(n.serializer,r)}function Ms(n){return he(n.integerValue||n.doubleValue)}function Qu(n){return Mo(n)&&n.arrayValue.values?n.arrayValue.values.slice():[]}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Fg{constructor(){this.changes=new ln(e=>e.toString(),(e,t)=>e.isEqual(t)),this.changesApplied=!1}addEntry(e){this.assertNotApplied(),this.changes.set(e.key,e)}removeEntry(e,t){this.assertNotApplied(),this.changes.set(e,ke.newInvalidDocument(e).setReadTime(t))}getEntry(e,t){this.assertNotApplied();const r=this.changes.get(t);return r!==void 0?k.resolve(r):this.getFromCache(e,t)}getEntries(e,t){return this.getAllFromCache(e,t)}apply(e){return this.assertNotApplied(),this.changesApplied=!0,this.applyChanges(e)}assertNotApplied(){}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const zi="RestConnection",cy={BatchGetDocuments:"batchGet",Commit:"commit",RunQuery:"runQuery",RunAggregationQuery:"runAggregationQuery",ExecutePipeline:"executePipeline"};class ly{get ko(){return!1}constructor(e){this.databaseInfo=e,this.databaseId=e.databaseId;const t=e.ssl?"https":"http",r=encodeURIComponent(this.databaseId.projectId),s=encodeURIComponent(this.databaseId.database);this.qo=t+"://"+e.host,this.Ko=`projects/${r}/databases/${s}`,this.Uo=this.databaseId.database===Ps?`project_id=${r}`:`project_id=${r}&database_id=${s}`}$o(e,t,r,s,i){const a=po(),c=this.Wo(e,t.toUriEncodedString());$(zi,`Sending RPC '${e}' ${a}:`,c,r);const u={"google-cloud-resource-prefix":this.Ko,"x-goog-request-params":this.Uo};this.Qo(u,s,i);const{host:d}=new URL(c),f=Vr(d);return this.Go(e,c,u,r,f).then(g=>($(zi,`Received RPC '${e}' ${a}: `,g),g),g=>{throw sn(zi,`RPC '${e}' ${a} failed with error: `,g,"url: ",c,"request:",r),g})}zo(e,t,r,s,i,a){return this.$o(e,t,r,s,i)}Qo(e,t,r){e["X-Goog-Api-Client"]=function(){return"gl-js/ fire/"+Nn}(),e["Content-Type"]="text/plain",this.databaseInfo.appId&&(e["X-Firebase-GMPID"]=this.databaseInfo.appId),t&&t.headers.forEach((s,i)=>e[i]=s),r&&r.headers.forEach((s,i)=>e[i]=s)}Wo(e,t){const r=cy[e];let s=`${this.qo}/v1/${t}:${r}`;return this.databaseInfo.apiKey&&(s=`${s}?key=${encodeURIComponent(this.databaseInfo.apiKey)}`),s}terminate(){}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function si(n){return new pg(n,!0)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Bs=new So("@firebase/auth");function R_(n,...e){Bs.logLevel<=Z.WARN&&Bs.warn(`Auth (${Mn}): ${n}`,...e)}function vs(n,...e){Bs.logLevel<=Z.ERROR&&Bs.error(`Auth (${Mn}): ${n}`,...e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function $_(n,e){return yt(n,"POST","/v1/accounts:delete",e)}async function js(n,e){return yt(n,"POST","/v1/accounts:lookup",e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function zs(n){var g;const e=n.auth,t=await n.getIdToken(),r=await Vn(n,js(e,{idToken:t}));j(r==null?void 0:r.users.length,e,"internal-error");const s=r.users[0];n._notifyReloadListener(s);const i=(g=s.providerUserInfo)!=null&&g.length?Zd(s.providerUserInfo):[],a=q_(n.providerData,i),c=n.isAnonymous,u=!(n.email&&s.passwordHash)&&!(a!=null&&a.length),d=c?u:!1,f={uid:s.localId,displayName:s.displayName||null,photoURL:s.photoUrl||null,email:s.email||null,emailVerified:s.emailVerified||!1,phoneNumber:s.phoneNumber||null,tenantId:s.tenantId||null,providerData:a,metadata:new To(s.createdAt,s.lastLoginAt),isAnonymous:d};Object.assign(n,f)}async function z_(n){const e=Ne(n);await zs(e),await e.auth._persistUserIfCurrent(e),e.auth._notifyListenersIfCurrent(e)}function q_(n,e){return[...n.filter(r=>!e.some(s=>s.providerId===r.providerId)),...e]}function Zd(n){return n.map(({providerId:e,...t})=>({providerId:e,uid:t.rawId||"",displayName:t.displayName||null,email:t.email||null,phoneNumber:t.phoneNumber||null,photoURL:t.photoUrl||null}))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Nl(n){const e=n.toLowerCase();if(e.includes("opera/")||e.includes("opr/")||e.includes("opios/"))return"Opera";if(sh(e))return"IEMobile";if(e.includes("msie")||e.includes("trident/"))return"IE";if(e.includes("edge/"))return"Edge";if(th(e))return"Firefox";if(e.includes("silk/"))return"Silk";if(oh(e))return"Blackberry";if(ah(e))return"Webos";if(nh(e))return"Safari";if((e.includes("chrome/")||rh(e))&&!e.includes("edge/"))return"Chrome";if(ih(e))return"Android";{const t=/([a-zA-Z\d\.]+)\/[a-zA-Z\d\.]*$/,r=n.match(t);if((r==null?void 0:r.length)===2)return r[1]}return"Other"}function th(n=De()){return/firefox\//i.test(n)}function nh(n=De()){const e=n.toLowerCase();return e.includes("safari/")&&!e.includes("chrome/")&&!e.includes("crios/")&&!e.includes("android")}function rh(n=De()){return/crios\//i.test(n)}function sh(n=De()){return/iemobile/i.test(n)}function ih(n=De()){return/android/i.test(n)}function oh(n=De()){return/blackberry/i.test(n)}function ah(n=De()){return/webos/i.test(n)}function da(n=De()){return/iphone|ipad|ipod/i.test(n)||/macintosh/i.test(n)&&/mobile/i.test(n)}function W_(n=De()){var e;return da(n)&&!!((e=window.navigator)!=null&&e.standalone)}function K_(){return Lf()&&document.documentMode===10}function ch(n=De()){return da(n)||ih(n)||ah(n)||oh(n)||/windows phone/i.test(n)||sh(n)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function lh(n,e=[]){let t;switch(n){case"Browser":t=Nl(De());break;case"Worker":t=`${Nl(De())}-${n}`;break;default:t=n}const r=e.length?e.join(","):"FirebaseCore-web";return`${t}/JsCore/${Mn}/${r}`}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Zv="pendingRedirect",ws=new Map;class eE extends Ch{constructor(e,t,r=!1){super(e,["signInViaRedirect","linkViaRedirect","reauthViaRedirect","unknown"],t,void 0,r),this.eventId=null}async execute(){let e=ws.get(this.auth._key());if(!e){try{const r=await tE(this.resolver,this.auth)?await super.execute():null;e=()=>Promise.resolve(r)}catch(t){e=()=>Promise.reject(t)}ws.set(this.auth._key(),e)}return this.bypassAuthState||ws.set(this.auth._key(),()=>Promise.resolve(null)),e()}async onAuthEvent(e){if(e.type==="signInViaRedirect")return super.onAuthEvent(e);if(e.type==="unknown"){this.resolve(null);return}if(e.eventId){const t=await this.auth._redirectUserForId(e.eventId);if(t)return this.user=t,super.onAuthEvent(e);this.resolve(null)}}async onExecution(){}cleanUp(){}}async function tE(n,e){const t=sE(e),r=rE(n);if(!await r._isAvailable())return!1;const s=await r._get(t)==="true";return await r._remove(t),s}function nE(n,e){ws.set(n._key(),e)}function rE(n){return lt(n._redirectPersistence)}function sE(n){return Es(Zv,n.config.apiKey,n.name)}async function iE(n,e,t=!1){if(Ue(n.app))return Promise.reject(dt(n));const r=hn(n),s=Kv(r,e),a=await new eE(r,s,t).execute();return a&&!t&&(delete a.user._redirectEventId,await r._persistUserIfCurrent(a.user),await r._setRedirectUser(null,e)),a}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
Las ventas y consumos vuelven a estar activos en el periodo actual. El cierre se borrará permanentemente.`,{confirmText:"Deshacer Cierre",cancelText:"Volver",isDestructive:!0})?(m.cierres=m.cierres.filter(t=>t.id!==n),m.cierres.length>0?m.ultimoCierre=m.cierres[m.cierres.length-1].timestamp:m.ultimoCierre=null,await Qe.saveCierres(!0),x.success("✅ Cierre eliminado. Ventas reactivadas."),!0):!1,descargarReporteCierre:n=>{const e=window.open("","_blank","width=850,height=600");if(!e){x.error("⚠️ El navegador bloqueó la ventana emergente. Por favor habilítalas.");return}e.document.write(`<!DOCTYPE html><html><head><meta charset="UTF-8">
  ...
  `}function Fh(){var S;if(!m.usuarioActual||!((((S=m.usuarioActual)==null?void 0:S.rol)||"").toLowerCase()==="admin"))return;const e=de.calcularBalances(),t=(e.balLocal||0)+(e.balChica||0),r=m.ventas.reduce((P,F)=>P+(F.ganancia||0),0),s=m.productos.reduce((P,F)=>P+(F.precioCosto||0)*F.stock,0),i=m.productos.reduce((P,F)=>{const q=(F.precio||0)-(F.precioCosto||0);return P+(q>0?q*F.stock:0)},0),a=m.movimientos.filter(P=>["egreso","retiro","reposicion"].includes(P.tipo)).reduce((P,F)=>P+F.monto,0),c=m.movimientos.filter(P=>P.tipo==="ingreso").reduce((P,F)=>P+F.monto,0),u=m.consumosDueno.reduce((P,F)=>P+(F.totalCosto||0),0),d=r+c-a-u,f=m.ventas.reduce((P,F)=>P+(F.monto||0),0),g=f>0?r/f*100:0,w=(P,F)=>{const q=document.getElementById(P);q&&(q.textContent=F)};w("dashDineroCaja",`S/ ${t.toFixed(2)}`),w("dashGananciaBruta",`S/ ${r.toFixed(2)}`),w("dashGananciaPotencial",`S/ ${i.toFixed(2)}`),w("dashUtilidadNeta",`S/ ${d.toFixed(2)}`),w("dashInversionStock",`S/ ${s.toFixed(2)}`),w("dashMargenPromedio",`${g.toFixed(1)}%`);const C=document.getElementById("dashAlertasContainer");if(C){const P=m.productos.filter(F=>F.stock<=F.stockMin&&F.stockMin>0);P.length>0?C.innerHTML=`
    ...
    `).join("")||"<p style='color:#999;'>Sin ventas aún</p>"}}function Nw(){var n,e;document.addEventListener("click",async t=>{const r=t.target.closest("[data-action]");switch(r==null?void 0:r.dataset.action){case"cerrar-dia":await Qe.cerrarDia()&&(hr(),document.dispatchEvent(new CustomEvent("caja:changed")));break;case"descargar-cierre":{const i=parseInt(r.dataset.id),a=m.cierres.find(c=>c.id===i);a&&Qe.descargarReporteCierre(a);break}case"eliminar-cierre":{const i=parseInt(r.dataset.id);await Qe.eliminarCierre(i)&&hr();break}case"descargar-mensual":{const i=parseInt(r.dataset.mes),a=parseInt(r.dataset.anio);Qe.descargarReporteMensualPDF(a,i);break}case"actualizar-mensual":As();break;case"cargar-mas-cierres":m.limiteCierres=(m.limiteCierres||10)+10,Nh();break}}),(n=document.getElementById("btnActualizarMensual"))==null||n.addEventListener("click",()=>As()),(e=document.getElementById("filtroAnioMensual"))==null||e.addEventListener("change",()=>As()),document.addEventListener("ventas:changed",()=>hr()),document.addEventListener("dashboard:changed",()=>{Fh(),hr()})}function wa(){const n=document.getElementById("tabErrores");if(!n)return;let e=n.querySelector("#erroresContainer");if(e||(e=document.createElement("div"),e.id="erroresContainer",e.style.padding="20px",e.style.minHeight="300px",n.appendChild(e)),m.erroresReportados.length===0){e.innerHTML=`
...
<body>
  ...
  `;const t=n.style.position;n.style.position="relative",n._prevPosition=t,n.appendChild(e)}function eu(n){const e=n==null?void 0:n.querySelector("#lazy-loading-overlay");e&&e.remove(),n&&n._prevPosition!==void 0&&(n.style.position=n._prevPosition||"",delete n._prevPosition)}async function tu(n){if(m.tabActual===n)return;m.tabActual=n,document.querySelectorAll(".tab").forEach(s=>{const i=s.dataset.tab===n;s.classList.toggle("active",i)});let e=null;document.querySelectorAll(".tab-content").forEach(s=>{const i=s.id.replace("tab","").toLowerCase(),a=n.toLowerCase(),c=i===a||s.id===`tab${eT(n)}`;s.classList.toggle("active",c),c&&(e=s)});const t=Jw[n];if(!t)return;if(Xw.has(n)&&!m.modulosCargados[n]){e&&Zw(e);try{await KE(n)}catch(s){console.error(`Error cargando datos del módulo ${n}:`,s),eu(e);return}eu(e)}try{t()}catch(s){console.error(`Error rendering tab ${n}:`,s)}}function eT(n){return n.charAt(0).toUpperCase()+n.slice(1)}function tT(){document.addEventListener("click",e=>{const t=e.target.closest("[data-tab]");if(!t)return;const r=t.dataset.tab;r&&tu(r)});const n=m.tabActual||"mesas";tu(n)}function nT(){document.addEventListener("click",async n=>{var r,s;const e=n.target.closest("[data-action]");if((e==null?void 0:e.dataset.action)==="guardar-configuracion"){const i=parseFloat((r=document.getElementById("tarifaHora"))==null?void 0:r.value),a=parseFloat((s=document.getElementById("tarifaExtra5Min"))==null?void 0:s.value);if(isNaN(i)||isNaN(a)){x.error("Por favor ingresa valores válidos");return}m.config.tarifaHora=i,m.config.tarifaExtra5Min=a,await ae(H.CONFIGURACION,Q.GENERAL,{tarifaHora:i,tarifaExtra5Min:a},!0),x.success("✅ Configuración guardada correctamente")}if(n.target.closest(".close-btn")||n.target.closest(".btn-gray")&&n.target.closest(".btn-gray").textContent.trim().toLowerCase()==="cancelar"){const i=n.target.closest(".modal");i&&i.classList.remove("show")}})}function rT(){tT()}async function nu(){sw(),rw(),hw(),Ew(),Sw(),Vw(),Nw(),Uw(),Gw(),Qw(),nT(),await nw(rT)}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",nu):nu();
