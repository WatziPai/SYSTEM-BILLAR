 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function z(n,e,t){let r="Unexpected state";typeof e=="string"?r=e:t=e,wu(n,r,t)}function wu(n,e,t){let r=`FIRESTORE (${Nn}) INTERNAL ASSERTION FAILED: ${e} (ID: ${n.toString(16)})`;if(t!==void 0)try{r+=" CONTEXT: "+JSON.stringify(t)}catch{r+=" CONTEXT: "+t}throw ft(r),new Error(r)}function re(n,e,t,r){let s="Unexpected state";typeof t=="string"?s=t:r=t,n||wu(e,s,r)}function W(n,e){return n}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Tu{constructor(e,t){this.user=t,this.type="OAuth",this.headers=new Map,this.headers.set("Authorization",`Bearer ${e}`)}}class tp{getToken(){return Promise.resolve(null)}invalidateToken(){}start(e,t){e.enqueueRetryable(()=>t(xe.UNAUTHENTICATED))}shutdown(){}}class np{constructor(e){this.token=e,this.changeListener=null}getToken(){return Promise.resolve(this.token)}invalidateToken(){}start(e,t){this.changeListener=t,e.enqueueRetryable(()=>t(this.token.user))}shutdown(){this.changeListener=null}}class rp{constructor(e){this.t=e,this.currentUser=xe.UNAUTHENTICATED,this.i=0,this.forceRefresh=!1,this.auth=null}start(e,t){re(this.o===void 0,42304);let r=this.i;const s=u=>this.i!==r?(r=this.i,t(u)):Promise.resolve();let i=new Vt;this.o=()=>{this.i++,this.currentUser=this.u(),i.resolve(),i=new Vt,e.enqueueRetryable(()=>s(this.currentUser))};const a=()=>{const u=i;e.enqueueRetryable(async()=>{await u.promise,await s(this.currentUser)})},c=u=>{$("FirebaseAuthCredentialsProvider","Auth detected"),this.auth=u,this.o&&(this.auth.addAuthTokenListener(this.o),a())};this.t.onInit(u=>c(u)),setTimeout(()=>{if(!this.auth){const u=this.t.getImmediate({optional:!0});u?c(u):($("FirebaseAuthCredentialsProvider","Auth not yet detected"),i.resolve(),i=new Vt)}},0),a()}getToken(){const e=this.i,t=this.forceRefresh;return this.forceRefresh=!1,this.auth?this.auth.getToken(t).then(r=>this.i!==e?($("FirebaseAuthCredentialsProvider","getToken aborted due to token change."),this.getToken()):r?(re(typeof r.accessToken=="string",31837,{l:r}),new Tu(r.accessToken,this.currentUser)):null):Promise.resolve(null)}invalidateToken(){this.forceRefresh=!0}shutdown(){this.auth&&this.o&&this.auth.removeAuthTokenListener(this.o),this.o=void 0}u(){const e=this.auth&&this.auth.getUid();return re(e===null||typeof e=="string",2055,{h:e}),new xe(e)}}class sp{constructor(e,t,r){this.P=e,this.T=t,this.I=r,this.type="FirstParty",this.user=xe.FIRST_PARTY,this.R=new Map}A(){return this.I?this.I():null}get headers(){this.R.set("X-Goog-AuthUser",this.P);const e=this.A();return e&&this.R.set("Authorization",e),this.T&&this.R.set("X-Goog-Iam-Authorization-Token",this.T),this.R}}class ip{constructor(e,t,r){this.P=e,this.T=t,this.I=r}getToken(){return Promise.resolve(new sp(this.P,this.T,this.I))}start(e,t){e.enqueueRetryable(()=>t(xe.FIRST_PARTY))}shutdown(){}invalidateToken(){}}class Nc{constructor(e){this.value=e,this.type="AppCheck",this.headers=new Map,e&&e.length>0&&this.headers.set("x-firebase-appcheck",this.value)}}class op{constructor(e,t){this.V=t,this.forceRefresh=!1,this.appCheck=null,this.m=null,this.p=null,Ue(e)&&e.settings.appCheckToken&&(this.p=e.settings.appCheckToken)}start(e,t){re(this.o===void 0,3512);const r=i=>{i.error!=null&&$("FirebaseAppCheckTokenProvider",`Error getting App Check token; using placeholder token instead. Error: ${i.error.message}`);const a=i.token!==this.m;return this.m=i.token,$("FirebaseAppCheckTokenProvider",`Received ${a?"new":"existing"} token.`),a?t(i.token):Promise.resolve()};this.o=i=>{e.enqueueRetryable(()=>r(i))};const s=i=>{$("FirebaseAppCheckTokenProvider","AppCheck detected"),this.appCheck=i,this.o&&this.appCheck.addTokenListener(this.o)};this.V.onInit(i=>s(i)),setTimeout(()=>{if(!this.appCheck){const i=this.V.getImmediate({optional:!0});i?s(i):$("FirebaseAppCheckTokenProvider","AppCheck not yet detected")}},0)}getToken(){if(this.p)return Promise.resolve(new Nc(this.p));const e=this.forceRefresh;return this.forceRefresh=!1,this.appCheck?this.appCheck.getToken(e).then(t=>t?(re(typeof t.token=="string",44558,{tokenResult:t}),this.m=t.token,new Nc(t.token)):null):Promise.resolve(null)}invalidateToken(){this.forceRefresh=!0}shutdown(){this.appCheck&&this.o&&this.appCheck.removeTokenListener(this.o),this.o=void 0}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Vo=-1;function Ys(n){return n==null}function Rs(n){return n===0&&1/n==-1/0}function vp(n){return typeof n=="number"&&Number.isInteger(n)&&!Rs(n)&&n<=Number.MAX_SAFE_INTEGER&&n>=Number.MIN_SAFE_INTEGER}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Su="server_timestamp",Ru="__type__",Pu="__previous_value__",xu="__local_write_time__";function Lo(n){var t,r;return((r=(((t=n==null?void 0:n.mapValue)==null?void 0:t.fields)||{})[Ru])==null?void 0:r.stringValue)===Su}function Qs(n){const e=n.mapValue.fields[Pu];return Lo(e)?Qs(e):e}function Er(n){const e=Nt(n.mapValue.fields[xu].timestampValue);return new oe(e.seconds,e.nanos)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ke{constructor(e,t,r,s,i,a,c){this.key=e,this.documentType=t,this.version=r,this.readTime=s,this.createTime=i,this.data=a,this.documentState=c}static newInvalidDocument(e){return new ke(e,0,G.min(),G.min(),G.min(),Be.empty(),0)}static newFoundDocument(e,t,r,s){return new ke(e,1,t,G.min(),r,s,0)}static newNoDocument(e,t){return new ke(e,2,t,G.min(),G.min(),Be.empty(),0)}static newUnknownDocument(e,t){return new ke(e,3,t,G.min(),G.min(),Be.empty(),2)}convertToFoundDocument(e,t){return!this.createTime.isEqual(G.min())||this.documentType!==2&&this.documentType!==0||(this.createTime=e),this.version=e,this.documentType=1,this.data=t,this.documentState=0,this}convertToNoDocument(e){return this.version=e,this.documentType=2,this.data=Be.empty(),this.documentState=0,this}convertToUnknownDocument(e){return this.version=e,this.documentType=3,this.data=Be.empty(),this.documentState=2,this}setHasCommittedMutations(){return this.documentState=2,this}setHasLocalMutations(){return this.documentState=1,this.version=G.min(),this}setReadTime(e){return this.readTime=e,this}get hasLocalMutations(){return this.documentState===1}get hasCommittedMutations(){return this.documentState===2}get hasPendingWrites(){return this.hasLocalMutations||this.hasCommittedMutations}isValidDocument(){return this.documentType!==0}isFoundDocument(){return this.documentType===1}isNoDocument(){return this.documentType===2}isUnknownDocument(){return this.documentType===3}isEqual(e){return e instanceof ke&&this.key.isEqual(e.key)&&this.version.isEqual(e.version)&&this.documentType===e.documentType&&this.documentState===e.documentState&&this.data.isEqual(e.data)}mutableCopy(){return new ke(this.key,this.documentType,this.version,this.readTime,this.createTime,this.data.clone(),this.documentState)}toString(){return`Document(${this.key}, ${this.version}, ${JSON.stringify(this.data.value)}, {createTime: ${this.createTime}}), {documentType: ${this.documentType}}), {documentState: ${this.documentState}})`}}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const qp=new ce(B.comparator);function mt(){return qp}const zu=new ce(B.comparator);function lr(...n){let e=zu;for(const t of n)e=e.insert(t.key,t);return e}function qu(n){let e=zu;return n.forEach((t,r)=>e=e.insert(t,r.overlayedDocument)),e}function Xt(){return pr()}function Hu(){return pr()}function pr(){return new ln(n=>n.toString(),(n,e)=>n.isEqual(e))}const Hp=new ce(B.comparator),Gp=new Ee(B.comparator);function X(...n){let e=Gp;for(const t of n)e=e.add(t);return e}const Wp=new Ee(J);function Kp(){return Wp}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ti(n,e){if(n.useProto3Json){if(isNaN(e))return{doubleValue:"NaN"};if(e===1/0)return{doubleValue:"Infinity"};if(e===-1/0)return{doubleValue:"-Infinity"}}return{doubleValue:Rs(e)?"-0":e}}function Fo(n){return{integerValue:""+n}}function Yp(n,e){return vp(e)?Fo(e):ti(n,e)}/**
 * @license
 * Copyright 2018 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */Fe.DEFAULT_COLLECTION_PERCENTILE=10,Fe.DEFAULT_MAX_SEQUENCE_NUMBERS_TO_COLLECT=1e3,Fe.DEFAULT=new Fe(ud,Fe.DEFAULT_COLLECTION_PERCENTILE,Fe.DEFAULT_MAX_SEQUENCE_NUMBERS_TO_COLLECT),Fe.DISABLED=new Fe(-1,0,0);/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Og{constructor(){this.changes=new ln(e=>e.toString(),(e,t)=>e.isEqual(t)),this.changesApplied=!1}addEntry(e){this.assertNotApplied(),this.changes.set(e.key,e)}removeEntry(e,t){this.assertNotApplied(),this.changes.set(e,ke.newInvalidDocument(e).setReadTime(t))}getEntry(e,t){this.assertNotApplied();const r=this.changes.get(t);return r!==void 0?k.resolve(r):this.getFromCache(e,t)}getEntries(e,t){return this.getAllFromCache(e,t)}apply(e){return this.assertNotApplied(),this.changesApplied=!0,this.applyChanges(e)}assertNotApplied(){}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Bs=new So("@firebase/auth");function S_(n,...e){Bs.logLevel<=Z.WARN&&Bs.warn(`Auth (${Mn}): ${n}`,...e)}function vs(n,...e){Bs.logLevel<=Z.ERROR&&Bs.error(`Auth (${Mn}): ${n}`,...e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function yr(n){if(n)try{const e=new Date(Number(n));if(!isNaN(e.getTime()))return e.toUTCString()}catch{}}async function $_(n,e=!1){const t=Ne(n),r=await t.getIdToken(e),s=ua(r);j(s&&s.exp&&s.auth_time&&s.iat,t.auth,"internal-error");const i=typeof s.firebase=="object"?s.firebase:void 0,a=i==null?void 0:i.sign_in_provider;return{claims:s,token:r,authTime:yr(Wi(s.auth_time)),issuedAtTime:yr(Wi(s.iat)),expirationTime:yr(Wi(s.exp)),signInProvider:a||null,signInSecondFactor:(i==null?void 0:i.sign_in_second_factor)||null}}function Wi(n){return Number(n)*1e3}function ua(n){const[e,t,r]=n.split(".");if(e===void 0||t===void 0||r===void 0)return vs("JWT malformed, contained fewer than 3 sections"),null;try{const s=su(t);return s?JSON.parse(s):(vs("Failed to decode base64 JWT payload"),null)}catch(s){return vs("Caught error parsing JWT payload as JSON",s==null?void 0:s.toString()),null}}function Vl(n){const e=ua(n);return j(e,"internal-error"),j(typeof e.exp<"u","internal-error"),j(typeof e.iat<"u","internal-error"),Number(e.exp)-Number(e.iat)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Nl(n){const e=n.toLowerCase();if(e.includes("opera/")||e.includes("opr/")||e.includes("opios/"))return"Opera";if(rh(e))return"IEMobile";if(e.includes("msie")||e.includes("trident/"))return"IE";if(e.includes("edge/"))return"Edge";if(eh(e))return"Firefox";if(e.includes("silk/"))return"Silk";if(ih(e))return"Blackberry";if(oh(e))return"Webos";if(th(e))return"Safari";if((e.includes("chrome/")||nh(e))&&!e.includes("edge/"))return"Chrome";if(sh(e))return"Android";{const t=/([a-zA-Z\d\.]+)\/[a-zA-Z\d\.]*$/,r=n.match(t);if((r==null?void 0:r.length)===2)return r[1]}return"Other"}function eh(n=De()){return/firefox\//i.test(n)}function th(n=De()){const e=n.toLowerCase();return e.includes("safari/")&&!e.includes("chrome/")&&!e.includes("crios/")&&!e.includes("android")}function nh(n=De()){return/crios\//i.test(n)}function rh(n=De()){return/iemobile/i.test(n)}function sh(n=De()){return/android/i.test(n)}function ih(n=De()){return/blackberry/i.test(n)}function oh(n=De()){return/webos/i.test(n)}function da(n=De()){return/iphone|ipad|ipod/i.test(n)||/macintosh/i.test(n)&&/mobile/i.test(n)}function G_(n=De()){var e;return da(n)&&!!((e=window.navigator)!=null&&e.standalone)}function W_(){return Vf()&&document.documentMode===10}function ah(n=De()){return da(n)||sh(n)||oh(n)||ih(n)||/windows phone/i.test(n)||rh(n)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ch(n,e=[]){let t;switch(n){case"Browser":t=Nl(De());break;case"Worker":t=`${Nl(De())}-${n}`;break;default:t=n}const r=e.length?e.join(","):"FirebaseCore-web";return`${t}/JsCore/${Mn}/${r}`}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function ph(n){const e=hn(n);e._getPasswordPolicyInternal()&&await e._updatePasswordPolicy()}async function bv(n,e,t){if(Ue(n.app))return Promise.reject(dt(n));const r=hn(n),a=await Io(r,{returnSecureToken:!0,email:e,password:t,clientType:"CLIENT_TYPE_WEB"},"signUpPassword",Ev).catch(u=>{throw u.code==="auth/password-does-not-meet-requirements"&&ph(n),u}),c=await an._fromIdTokenResponse(r,"signIn",a);return await r._updateCurrentUser(c.user),c}function Av(n,e,t){return Ue(n.app)?Promise.reject(dt(n)):Iv(Ne(n),Un.credential(e,t)).catch(async r=>{throw r.code==="auth/password-does-not-meet-requirements"&&ph(n),r})}function Cv(n,e){return Sv(Ne(n),null,e)}async function Sv(n,e,t){const{auth:r}=n,i={idToken:await n.getIdToken(),returnSecureToken:!0};t&&(i.password=t);const a=await Vn(n,hv(r,i));await n._updateTokensIfNecessary(a,!0)}function Rv(n,e,t,r){return Ne(n).onIdTokenChanged(e,t,r)}function Pv(n,e,t){return Ne(n).beforeAuthStateChanged(e,t)}function xv(n,e,t,r){return Ne(n).onAuthStateChanged(e,t,r)}function kv(n){return Ne(n).signOut()}const Hs="__sak";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Xv="pendingRedirect",ws=new Map;class Zv extends Ah{constructor(e,t,r=!1){super(e,["signInViaRedirect","linkViaRedirect","reauthViaRedirect","unknown"],t,void 0,r),this.eventId=null}async execute(){let e=ws.get(this.auth._key());if(!e){try{const r=await eE(this.resolver,this.auth)?await super.execute():null;e=()=>Promise.resolve(r)}catch(t){e=()=>Promise.reject(t)}ws.set(this.auth._key(),e)}return this.bypassAuthState||ws.set(this.auth._key(),()=>Promise.resolve(null)),e()}async onAuthEvent(e){if(e.type==="signInViaRedirect")return super.onAuthEvent(e);if(e.type==="unknown"){this.resolve(null);return}if(e.eventId){const t=await this.auth._redirectUserForId(e.eventId);if(t)return this.user=t,super.onAuthEvent(e);this.resolve(null)}}async onExecution(){}cleanUp(){}}async function eE(n,e){const t=rE(e),r=nE(n);if(!await r._isAvailable())return!1;const s=await r._get(t)==="true";return await r._remove(t),s}function tE(n,e){ws.set(n._key(),e)}function nE(n){return lt(n._redirectPersistence)}function rE(n){return Es(Xv,n.config.apiKey,n.name)}async function sE(n,e,t=!1){if(Ue(n.app))return Promise.reject(dt(n));const r=hn(n),s=Wv(r,e),a=await new Zv(r,s,t).execute();return a&&!t&&(delete a.user._redirectEventId,await r._persistUserIfCurrent(a.user),await r._setRedirectUser(null,e)),a}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ki="webStorageSupport";class LE{constructor(){this.eventManagers={},this.iframes={},this.originValidationPromises={},this._redirectPersistence=vh,this._completeRedirectFn=sE,this._overrideRedirectResult=tE}async _openPopup(e,t,r,s){var a;pt((a=this.eventManagers[e._key()])==null?void 0:a.manager,"_initialize() not called before _openPopup()");const i=await Gl(e,t,r,wo(),s);return RE(e,i,ma())}async _openRedirect(e,t,r,s){await this._originValidation(e);const i=await Gl(e,t,r,wo(),s);return Ov(i),new Promise(()=>{})}_initialize(e){const t=e._key();if(this.eventManagers[t]){const{manager:s,promise:i}=this.eventManagers[t];return s?Promise.resolve(s):(pt(i,"If manager is not set, promise should be"),i)}const r=this.initAndGetManager(e);return this.eventManagers[t]={promise:r},r.catch(()=>{delete this.eventManagers[t]}),r}async initAndGetManager(e){const t=await TE(e),r=new oE(e);return t.register("authEvent",s=>(j(s==null?void 0:s.authEvent,e,"invalid-auth-event"),{status:r.onEvent(s.authEvent)?"ACK":"ERROR"}),gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER),this.eventManagers[e._key()]={manager:r},this.iframes[e._key()]=t,r}_isIframeWebStorageSupported(e,t){this.iframes[e._key()].send(Ki,{type:Ki},s=>{var a;const i=(a=s==null?void 0:s[0])==null?void 0:a[Ki];i!==void 0&&t(!!i),Ge(e,"internal-error")},gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER)}_originValidation(e){const t=e._key();return this.originValidationPromises[t]||(this.originValidationPromises[t]=dE(e)),this.originValidationPromises[t]}get _shouldInitProactively(){return ah()||th()||da()}}const ME=LE;var Wl="@firebase/auth",Kl="1.13.2";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const $E=5*60,UE=au("authIdTokenMaxAge")||$E;let Yl=null;const BE=n=>async e=>{const t=e&&await e.getIdTokenResult(),r=t&&(new Date().getTime()-Date.parse(t.issuedAtTime))/1e3;if(r&&r>UE)return;const s=t==null?void 0:t.token;Yl!==s&&(Yl=s,await fetch(n,{method:s?"POST":"DELETE",headers:s?{Authorization:`Bearer ${s}`}:{}}))};function jE(n=hu()){const e=Po(n,"auth");if(e.isInitialized())return e.getImmediate();const t=av(n,{popupRedirectResolver:ME,persistence:[Gv,Lv,vh]}),r=au("authTokenSyncURL");if(r&&typeof isSecureContext=="boolean"&&isSecureContext){const i=new URL(r,location.origin);if(location.origin===i.origin){const a=BE(i.toString());Pv(t,a,()=>a(t.currentUser)),Rv(t,c=>a(c))}}const s=iu("auth");return s&&lv(t,`http://${s}`),t}function zE(){var n;return((n=document.getElementsByTagName("head"))==null?void 0:n[0])??document}Z_({loadJS(n){return new Promise((e,t)=>{const r=document.createElement("script");r.setAttribute("src",n),r.onload=e,r.onerror=s=>{const i=nt("internal-error");i.customData=s,t(i)},r.type="text/javascript",r.charset="UTF-8",zE().appendChild(r)})},gapiScript:"https://apis.google.com/js/api.js",recaptchaV2Script:"https://www.google.com/recaptcha/api.js",recaptchaEnterpriseScript:"https://www.google.com/recaptcha/enterprise.js?render="});FE("Browser");const qE={apiKey:"AIzaSyCMJbPKQ434-pSvCXnleNkancO1RN7kn_Y",authDomain:"billar-system.firebaseapp.com",projectId:"billar-system",storageBucket:"billar-system.firebasestorage.app",messagingSenderId:"503671587493",appId:"1:503671587493:web:88e1a1ddfb7bd21ba4c34c"},Sh=du(qE),Yi=o_(Sh),ir=jE(Sh);const H={USUARIOS:"usuarios",VENTAS:"ventas",PRODUCTOS:"productos",MESAS:"mesas",ERRORES:"errores",CIERRES:"cierres",CONSUMOS:"consumos",CONFIGURACION:"configuracion",CAJA:"caja",LOTES:"lotes_agotados"},Q={TODOS:"todos",TODAS:"todas",BILLAR:"billar",CONSUMO:"consumo",HISTORIAL:"historial",DUENO:"dueno",GENERAL:"general"},Rh={TIEMPO_EXPIRACION:30*60*1e3},Je={signIn:async(n,e)=>Av(ir,n,e),signOut:async()=>kv(ir),onAuthChange:n=>xv(ir,n),getCurrentUser:()=>ir.currentUser,createUser:async(n,e)=>bv(ir,n,e),updatePassword:async(n,e)=>Cv(n,e)};let Ph=!1;setTimeout(()=>{Ph=!0},500);const Pe={isReady:()=>Ph,get:async(n,e)=>{try{`${n}${e}`;const t=Gi(Yi,n,e),r=await T_(t);return r.exists()?r.data():(`${n}${e}`,null)}catch(t){throw t}},listen:(n,e,t)=>{try{`${n}${e}`;const r=Gi(Yi,n,e);return b_(r,s=>{s.exists()?t(s.data()):t(null)},s=>{`${n}${e}`})}catch(r){throw r}},set:async(n,e,t)=>{try{`${n}${e}`;const r=Gi(Yi,n,e),s={...t,ultimaActualizacion:y_()};return await I_(r,s),!0}catch(r){throw r}}};class HE{constructor(){this.container=null,this.initContainer()}initContainer(){this.container||(this.container=document.createElement("div"),this.container.id="toastContainer",this.container.className="toast-container",document.body.appendChild(this.container))}show(e,t,r=3500){this.initContainer();const s=document.createElement("div");s.className=`toast toast-${e}`;const i={success:"✅",error:"❌",warning:"⚠️",info:"ℹ️"};s.innerHTML=`
      <span class="toast-icon">${i[e]||""}</span>
      <span class="toast-message">${t}</span>
      <span class="toast-close">&times;</span>
    `,this.container.appendChild(s),`${e.toUpperCase()}${t}`,requestAnimationFrame(()=>{s.classList.add("toast-show")});const a=s.querySelector(".toast-close"),c=()=>{s.classList.remove("toast-show"),s.classList.add("out"),s.addEventListener("animationend",()=>{s.remove()})};a.addEventListener("click",c),setTimeout(()=>{s.parentNode&&c()},r)}success(e,t){this.show("success",e,t)}error(e,t){this.show("error",e,t)}warning(e,t){this.show("warning",e,t)}info(e,t){this.show("info",e,t)}}const x=new HE;window.toast=x;const m={usuarioActual:null,usuarios:[],mesas:[],mesasConsumo:[],ventas:[],productos:[],erroresReportados:[],cierres:[],lotesAgotados:[],consumosDueno:[],movimientos:[],ultimoCierre:null,config:{tarifaHora:5,tarifaExtra5Min:1},limiteVentas:20,limiteMovimientos:20,limiteCierres:10,tabActual:null,ordenInventarioActual:"default",timers:{},modulosCargados:{ventas:!1,caja:!1,inventario:!1,reportes:!1,errores:!1,consumoDueno:!1}};async function GE(){const n=Date.now();try{const[e,t,r,s,i]=await Promise.all([Pe.get(H.USUARIOS,Q.TODOS),Pe.get(H.CONFIGURACION,Q.GENERAL),Pe.get(H.PRODUCTOS,Q.TODOS),Pe.get(H.MESAS,Q.BILLAR),Pe.get(H.MESAS,Q.CONSUMO)]);if(m.usuarios=(e==null?void 0:e.lista)||[],t){m.config={tarifaHora:parseFloat(t.tarifaHora)||5,tarifaExtra5Min:parseFloat(t.tarifaExtra5Min)||1};const c=document.getElementById("tarifaHora"),u=document.getElementById("tarifaExtra5Min");c&&(c.value=m.config.tarifaHora.toFixed(2)),u&&(u.value=m.config.tarifaExtra5Min.toFixed(2))}m.productos=(r==null?void 0:r.lista)||[],s&&s.lista?m.mesas=s.lista:(m.mesas=Array.from({length:4},(c,u)=>({id:u+1,ocupada:!1,inicio:null,tiempoTranscurrido:0,consumos:[]})),await ae(H.MESAS,Q.BILLAR,{lista:m.mesas},!0)),i&&i.lista?m.mesasConsumo=i.lista:(m.mesasConsumo=Array.from({length:2},(c,u)=>({id:u+1,ocupada:!1,consumos:[],total:0})),await ae(H.MESAS,Q.CONSUMO,{lista:m.mesasConsumo},!0));const a=Date.now()-n;`${a}`}catch(e){throw e}}async function WE(n){const e=m.modulosCargados;try{switch(n){case"caja":{if(e.caja)return;const t=await Pe.get(H.CAJA,Q.HISTORIAL);m.movimientos=(t==null?void 0:t.lista)||[],e.caja=!0;break}case"inventario":{if(e.inventario)return;const[t,r]=await Promise.all([Pe.get(H.PRODUCTOS,Q.TODOS),Pe.get(H.LOTES,Q.TODOS)]);m.productos=(t==null?void 0:t.lista)||[],m.lotesAgotados=(r==null?void 0:r.lista)||[],e.inventario=!0;break}case"ventas":{if(e.ventas)return;const t=await Pe.get(H.VENTAS,Q.TODAS);m.ventas=(t==null?void 0:t.lista)||[],e.ventas=!0;break}case"reportes":case"dashboard":case"mensual":{if(e.reportes)return;const[t,r,s]=await Promise.all([Pe.get(H.CIERRES,Q.HISTORIAL),Pe.get(H.CONSUMOS,Q.DUENO),e.ventas?Promise.resolve(null):Pe.get(H.VENTAS,Q.TODAS)]);m.cierres=(t==null?void 0:t.lista)||[],m.cierres.length>0&&(m.ultimoCierre=m.cierres[m.cierres.length-1].timestamp),m.consumosDueno=((r==null?void 0:r.lista)||[]).map(i=>({...i,total:i.total!==void 0?i.total:i.totalVenta||0})),s&&(m.ventas=s.lista||[],e.ventas=!0),e.reportes=!0,e.consumoDueno=!0;break}case"errores":{if(e.errores)return;const t=await Pe.get(H.ERRORES,Q.TODOS);m.erroresReportados=(t==null?void 0:t.lista)||[],e.errores=!0;break}case"consumoDueno":{if(e.consumoDueno)return;const t=await Pe.get(H.CONSUMOS,Q.DUENO);m.consumosDueno=((t==null?void 0:t.lista)||[]).map(r=>({...r,total:r.total!==void 0?r.total:r.totalVenta||0})),e.consumoDueno=!0;break}default:break}}catch(t){throw t}}async function ae(n,e,t,r=!1){try{if(!r&&t&&Array.isArray(t.lista))try{const s=await Pe.get(n,e);if(s&&Array.isArray(s.lista)){const i=new Map;t.lista.forEach(c=>{c&&c.id&&i.set(c.id,c)});let a=!1;s.lista.forEach(c=>{c&&c.id&&!i.has(c.id)&&(t.lista.push(c),a=!0)}),a&&(n===H.CAJA||n===H.CONSUMOS?t.lista.sort((c,u)=>u.id-c.id):(n===H.VENTAS||n===H.CIERRES)&&t.lista.sort((c,u)=>c.id-u.id),n===H.VENTAS&&(m.ventas=t.lista),n===H.CAJA&&(m.movimientos=t.lista),n===H.PRODUCTOS&&(m.productos=t.lista),n===H.CONSUMOS&&(m.consumosDueno=t.lista),`${n}${e}`,void 0)}}catch(s){console.warn("⚠️ No se pudo sincronizar antes de guardar:",s)}return await Pe.set(n,e,t),`${n}${e}`,!0}catch{return x.error(`Error al guardar datos en ${n}`),!1}}class KE{constructor(){this.dialogEl=null}show(e,t,r={}){const{confirmText:s="Aceptar",cancelText:i="Cancelar",isDestructive:a=!1}=r;return new Promise(c=>{this.close(),this.dialogEl=document.createElement("div"),this.dialogEl.className="confirm-dialog-overlay";const u=a?"btn-red":"btn-green";this.dialogEl.innerHTML=`
...
¿Deseas reponer el stock de este lote ahora?`,await fe.show("🚨 Producto Agotado",i,{confirmText:"Reponer ahora",cancelText:"Cerrar"})){const c=new CustomEvent("triggerAdjustStock",{detail:{id:n.id}});window.dispatchEvent(c)}},procesarConsumoProducto:async(n,e,t=!1)=>{const r=m.productos.find(c=>c.id===n);if(!r)return 0;const s=r.stock||0;if(s<e)throw x.error(`⚠️ No hay suficiente stock de ${r.nombre} (Stock: ${s})`),new Error("Sin stock");r.stock=s-e;const i=(r.precio||0)-(r.precioCosto||0),a=t?0:i*e;if(t?r.unidadesConsumidasDueno=(r.unidadesConsumidasDueno||0)+e:(r.unidadesVendidas=(r.unidadesVendidas||0)+e,r.gananciaAcumulada=(r.gananciaAcumulada||0)+a),r.nombre,r.stock,r.tamanoLote&&r.tamanoLote>0&&(r.conteoAcumuladoLote||(r.conteoAcumuladoLote=0),r.conteoAcumuladoLote+=e,r.conteoAcumuladoLote>=r.tamanoLote)){const c=Math.floor(r.conteoAcumuladoLote/r.tamanoLote),u=r.conteoAcumuladoLote%r.tamanoLote;for(let d=0;d<c;d++)await ye.generarReporteAgotamiento(r,!0);r.conteoAcumuladoLote=u,r.nombre}return r.stock===0&&(await ye.generarReporteAgotamiento(r,!1),setTimeout(()=>ye.notificarAgotamiento(r),100)),await ye.save(),a}};function ga(n,e=m.config){const t=parseFloat(e.tarifaHora)||5,r=parseFloat(e.tarifaExtra5Min)||1,s=Math.floor(n/60),i=Math.floor(s/60),a=s%60,c=i*t;let u=0;if(a>5){const d=a-5;u=Math.ceil(d/10)*r}return{costo:c+u,minutos:s,horas:i,minutosExtra:a,bloques:a>5?Math.ceil((a-5)/10):0}}const te={saveMesas:async(n=!1)=>await ae(H.MESAS,Q.BILLAR,{lista:m.mesas},n),saveMesasConsumo:async(n=!1)=>await ae(H.MESAS,Q.CONSUMO,{lista:m.mesasConsumo},n),agregarMesa:async()=>{if((m.usuarioActual.rol||"").toLowerCase()!=="admin")return x.error("⚠️ Solo los administradores pueden agregar mesas"),!1;const n=m.mesas.length>0?Math.max(...m.mesas.map(e=>e.id))+1:1;return m.mesas.push({id:n,ocupada:!1,inicio:null,tiempoTranscurrido:0,consumos:[]}),te.saveMesas().catch(console.error),x.success(`✅ Agregando mesa de billar ${n}...`),!0},eliminarMesa:async n=>{if((m.usuarioActual.rol||"").toLowerCase()!=="admin")return x.error("⚠️ Solo los administradores pueden eliminar mesas"),!1;const e=m.mesas.find(r=>r.id===n);return e&&e.ocupada?(x.error("⚠️ No puedes eliminar una mesa ocupada. Finalízala primero."),!1):await fe.show("🗑️ Eliminar Mesa",`¿Estás seguro de eliminar la Mesa ${n} del billar?`,{confirmText:"Eliminar",cancelText:"Cancelar",isDestructive:!0})?(m.mesas=m.mesas.filter(r=>r.id!==n),m.timers[n]&&(clearInterval(m.timers[n]),delete m.timers[n]),te.saveMesas(!0).catch(console.error),x.success(`✅ Eliminando mesa ${n}...`),!0):!1},iniciarMesa:async n=>{const e=m.mesas.find(t=>t.id===n);return e?(e.ocupada=!0,e.inicio=Date.now(),e.tiempoTranscurrido=0,e.consumos=[],te.saveMesas().catch(console.error),x.success(`▶️ Iniciando mesa de billar ${n}...`),!0):!1},finalizarMesa:async(n,e)=>{const t=m.mesas.find(w=>w.id===n);if(!t||!t.ocupada)return!1;const r=new Date(t.inicio).toLocaleString("es-PE",{hour:"2-digit",minute:"2-digit"}),s=new Date().toLocaleString("es-PE",{hour:"2-digit",minute:"2-digit"}),i=ga(t.tiempoTranscurrido),a=i.costo;let c=0,u=[];t.consumos&&t.consumos.length>0&&t.consumos.forEach(w=>{const C=w.precio*w.cantidad;c+=C,u.push({producto:w.nombre,cantidad:w.cantidad,precioUnitario:w.precio,subtotal:C})});const d=a+c;if(d<=0)return m.timers[n]&&(clearInterval(m.timers[n]),delete m.timers[n]),t.ocupada=!1,t.inicio=null,t.tiempoTranscurrido=0,t.consumos=[],te.saveMesas().catch(console.error),x.info(`⏹️ Cerrando mesa ${n} sin costo...`),!0;let f=a;t.consumos.forEach(w=>{const C=m.productos.find(O=>O.id===w.id),M=C&&C.precioCosto||0;f+=(w.precio-M)*w.cantidad});const g={id:Date.now(),tipo:"Mesa Billar",tipoDetalle:`Mesa ${t.id}`,monto:d,ganancia:f,metodoPago:e.metodoPago,montoEfectivo:e.montoEfectivo,montoYape:e.montoYape,fecha:new Date().toLocaleString("es-PE"),usuario:m.usuarioActual.nombre,detalle:{mesaId:t.id,horaInicio:r,horaFin:s,tiempoMinutos:i.minutos,tiempoHoras:i.horas,tiempoMinutosExtra:i.minutosExtra,costoTiempo:a,consumos:u,totalConsumos:c}};return m.ventas.push(g),ae(H.VENTAS,Q.TODAS,{lista:m.ventas}).catch(console.error),m.timers[n]&&(clearInterval(m.timers[n]),delete m.timers[n]),t.ocupada=!1,t.inicio=null,t.tiempoTranscurrido=0,t.consumos=[],te.saveMesas().catch(console.error),x.success(`✅ Procesando cobro de Mesa ${n} (S/ ${d.toFixed(2)})...`),!0},agregarMesaConsumo:async()=>{if((m.usuarioActual.rol||"").toLowerCase()!=="admin")return x.error("⚠️ Solo los administradores pueden agregar mesas"),!1;const n=m.mesasConsumo.length>0?Math.max(...m.mesasConsumo.map(e=>e.id))+1:1;return m.mesasConsumo.push({id:n,ocupada:!1,consumos:[],total:0}),te.saveMesasConsumo().catch(console.error),x.success(`✅ Agregando mesa de consumo ${n}...`),!0},eliminarMesaConsumo:async n=>{if((m.usuarioActual.rol||"").toLowerCase()!=="admin")return x.error("⚠️ Solo los administradores pueden eliminar mesas"),!1;const e=m.mesasConsumo.find(r=>r.id===n);return e&&e.ocupada?(x.error("⚠️ No puedes eliminar una mesa ocupada. Finalízala primero."),!1):await fe.show("🗑️ Eliminar Mesa Consumo",`¿Estás seguro de eliminar la Mesa de Consumo ${n}?`,{confirmText:"Eliminar",cancelText:"Cancelar",isDestructive:!0})?(m.mesasConsumo=m.mesasConsumo.filter(r=>r.id!==n),te.saveMesasConsumo(!0).catch(console.error),x.success(`✅ Eliminando mesa de consumo ${n}...`),!0):!1},iniciarMesaConsumo:async n=>{const e=m.mesasConsumo.find(t=>t.id===n);return e?(e.ocupada=!0,e.consumos=[],e.total=0,te.saveMesasConsumo().catch(console.error),x.success(`▶️ Iniciando mesa de consumo ${n}...`),!0):!1},finalizarMesaConsumo:async(n,e)=>{const t=m.mesasConsumo.find(c=>c.id===n);if(!t||!t.ocupada)return!1;if(t.total<=0)return t.ocupada=!1,t.consumos=[],t.total=0,te.saveMesasConsumo().catch(console.error),x.info(`⏹️ Cerrando mesa de consumo ${n} sin costo...`),!0;let r=[];t.consumos.forEach(c=>{const u=c.precio*c.cantidad;r.push({producto:c.nombre,cantidad:c.cantidad,precioUnitario:c.precio,subtotal:u})});let s=0;t.consumos.forEach(c=>{const u=m.productos.find(f=>f.id===c.id),d=u&&u.precioCosto||0;s+=(c.precio-d)*c.cantidad});const i={id:Date.now(),tipo:"Mesa Consumo",tipoDetalle:`Mesa Consumo ${t.id}`,monto:t.total,ganancia:s,metodoPago:e.metodoPago,montoEfectivo:e.montoEfectivo,montoYape:e.montoYape,fecha:new Date().toLocaleString("es-PE"),usuario:m.usuarioActual.nombre,detalle:{mesaId:t.id,consumos:r,totalConsumos:t.total}};m.ventas.push(i),ae(H.VENTAS,Q.TODAS,{lista:m.ventas}).catch(console.error);const a=t.total;return t.ocupada=!1,t.consumos=[],t.total=0,te.saveMesasConsumo().catch(console.error),x.success(`✅ Procesando cobro de Mesa de consumo ${n} (S/ ${a.toFixed(2)})...`),!0},agregarConsumo:async(n,e,t)=>{const r=m.productos.find(a=>a.id===n);if(!r||r.stock<=0)return x.error("⚠️ El producto no tiene stock disponible"),!1;let s=t==="billar"?m.mesas.find(a=>a.id===e):m.mesasConsumo.find(a=>a.id===e);if(!s||!s.ocupada)return x.error("⚠️ La mesa seleccionada no está ocupada"),!1;s.consumos||(s.consumos=[]);const i=s.consumos.find(a=>a.id===n);return i?i.cantidad++:s.consumos.push({id:n,nombre:r.nombre,precio:r.precio,cantidad:1}),ye.procesarConsumoProducto(n,1,!1).catch(console.error),t==="consumo"&&(s.total=s.consumos.reduce((a,c)=>a+c.precio*c.cantidad,0)),t==="billar"?te.saveMesas().catch(console.error):te.saveMesasConsumo().catch(console.error),x.success(`➕ ${r.nombre} agregado a la mesa`),!0},eliminarConsumo:async(n,e,t)=>{let r=t==="billar"?m.mesas.find(a=>a.id===e):m.mesasConsumo.find(a=>a.id===e);if(!r)return!1;const s=r.consumos.find(a=>a.id===n);if(!s)return!1;const i=m.productos.find(a=>a.id===n);if(i){i.stock+=s.cantidad;const c=((i.precio||0)-(i.precioCosto||0))*s.cantidad;i.unidadesVendidas=Math.max(0,(i.unidadesVendidas||0)-s.cantidad),i.gananciaAcumulada=Math.max(0,(i.gananciaAcumulada||0)-c),i.tamanoLote&&i.tamanoLote>0&&(i.conteoAcumuladoLote=Math.max(0,(i.conteoAcumuladoLote||0)-s.cantidad)),ye.save().catch(console.error)}return r.consumos=r.consumos.filter(a=>a.id!==n),t==="consumo"&&(r.total=r.consumos.reduce((a,c)=>a+c.precio*c.cantidad,0)),t==="billar"?te.saveMesas(!0).catch(console.error):te.saveMesasConsumo(!0).catch(console.error),x.success("🗑️ Producto removido de la mesa"),!0},editarConsumo:async(n,e,t,r)=>{let s=t==="billar"?m.mesas.find(d=>d.id===e):m.mesasConsumo.find(d=>d.id===e);if(!s)return!1;const i=s.consumos.find(d=>d.id===n);if(!i)return!1;const a=m.productos.find(d=>d.id===n),c=parseInt(r);if(isNaN(c)||c<0)return x.error("⚠️ Por favor ingresa una cantidad numérica válida"),!1;if(c===0)return await fe.show("🗑️ Eliminar Consumo",`¿Deseas remover por completo "${i.nombre}" de la mesa?`,{confirmText:"Remover",cancelText:"Cancelar",isDestructive:!0})&&await te.eliminarConsumo(n,e,t),!0;const u=c-i.cantidad;if(u>0&&a&&a.stock<u)return x.error(`⚠️ Stock insuficiente. Disponible en estante: ${a.stock}`),!1;if(a){a.stock-=u;const d=(a.precio||0)-(a.precioCosto||0);if(u>0)a.unidadesVendidas=(a.unidadesVendidas||0)+u,a.gananciaAcumulada=(a.gananciaAcumulada||0)+d*u,a.tamanoLote&&a.tamanoLote>0&&(a.conteoAcumuladoLote=(a.conteoAcumuladoLote||0)+u);else if(u<0){const f=Math.abs(u);a.unidadesVendidas=Math.max(0,(a.unidadesVendidas||0)-f),a.gananciaAcumulada=Math.max(0,(a.gananciaAcumulada||0)-d*f),a.tamanoLote&&a.tamanoLote>0&&(a.conteoAcumuladoLote=Math.max(0,(a.conteoAcumuladoLote||0)-f))}ye.save().catch(console.error)}return i.cantidad=c,t==="consumo"&&(s.total=s.consumos.reduce((d,f)=>d+f.precio*f.cantidad,0)),t==="billar"?te.saveMesas().catch(console.error):te.saveMesasConsumo().catch(console.error),x.success("✅ Consumos modificados correctamente"),!0}},Qi=new Map,Ji=new Map,en={open:n=>{const e=document.getElementById(n);if(!e)return;e.classList.remove("hidden"),requestAnimationFrame(()=>{e.classList.add("show")});const t=s=>{s.key==="Escape"&&en.close(n)};document.addEventListener("keydown",t),Qi.set(n,t);const r=s=>{s.target===e&&en.close(n)};e.addEventListener("click",r),Ji.set(n,r)},close:n=>{const e=document.getElementById(n);if(!e)return;e.classList.remove("show");const t=Qi.get(n);t&&(document.removeEventListener("keydown",t),Qi.delete(n));const r=Ji.get(n);r&&(e.removeEventListener("click",r),Ji.delete(n)),setTimeout(()=>{e.classList.contains("show")||e.classList.add("hidden")},200)}};window.openModal=en.open;window.closeModal=en.close;function iw(n){return`S/ ${(typeof n=="number"?n:parseFloat(n||0)).toFixed(2)}`}class ow{constructor(){this.modalId="modalConfirmacionPago",this.total=0,this.resolvePromise=null}show(e,t="Resumen de cobro"){return this.total=Number(e||0),`${this.total.toFixed(2)}`,new Promise(r=>{this.resolvePromise=r;const s=document.getElementById("pagoDetalle"),i=document.getElementById("pagoMonto"),a=document.getElementById("pagoMixtoEfectivo"),c=document.getElementById("pagoMixtoYape"),u=document.getElementById("pagoMixtoInputs");s&&(s.textContent=t),i&&(i.textContent=iw(this.total)),a&&(a.value=""),c&&(c.value=""),u&&u.classList.add("hidden");const d=document.querySelector('input[name="metodoPagoConf"][value="Efectivo"]');d&&(d.checked=!0),en.open(this.modalId),this.initEvents()})}initEvents(){const e=document.getElementById("pagoMixtoInputs"),t=document.getElementById("pagoMixtoEfectivo"),r=document.getElementById("pagoMixtoYape");document.querySelectorAll('input[name="metodoPagoConf"]').forEach(c=>{c.onchange=()=>{c.value==="Mixto"?(e.classList.remove("hidden"),t&&(t.value="",t.focus()),r&&(r.value=this.total.toFixed(2))):e.classList.add("hidden")}}),t&&(t.oninput=()=>{let c=parseFloat(t.value)||0;c>this.total?(c=this.total,t.value=this.total.toFixed(2)):c<0&&(c=0,t.value="0.00");const u=this.total-c;r&&(r.value=u.toFixed(2))});const i=document.getElementById("btnConfirmarPagoFinal");i&&(i.onclick=()=>{const c=document.querySelector('input[name="metodoPagoConf"]:checked'),u=c?c.value:"Efectivo";let d={metodoPago:u,monto:this.total,montoEfectivo:0,montoYape:0};if(u==="Efectivo")d.montoEfectivo=this.total;else if(u==="Yape")d.montoYape=this.total;else if(u==="Mixto"){const f=parseFloat(t.value)||0,g=this.total-f;if(f<=0||f>=this.total){alert("⚠️ Por favor ingresa un monto de efectivo válido entre 0 y el total.");return}d.montoEfectivo=f,d.montoYape=g}en.close(this.modalId),this.resolvePromise&&(this.resolvePromise(d),this.resolvePromise=null)});const a=document.getElementById("btnAtrasPago");a&&(a.onclick=()=>{en.close(this.modalId),this.resolvePromise&&(this.resolvePromise(null),this.resolvePromise=null)})}}const ya=new ow;window.paymentModal=ya;function Jl(n){const e=m.mesas.find(d=>d.id===n);if(!e||!e.ocupada)return;e.tiempoTranscurrido=Math.floor((Date.now()-e.inicio)/1e3);const t=Math.floor(e.tiempoTranscurrido/3600),r=Math.floor(e.tiempoTranscurrido%3600/60),s=e.tiempoTranscurrido%60,i=`${String(t).padStart(2,"0")}:${String(r).padStart(2,"0")}:${String(s).padStart(2,"0")}`,a=ga(e.tiempoTranscurrido),c=document.querySelector(`#mesa-${n} .timer-display`),u=document.querySelector(`#mesa-${n} .costo-display`);c&&(c.textContent=i),u&&(u.textContent=`S/ ${a.costo.toFixed(2)}`)}function Qt(){const n=document.getElementById("mesasContainer");if(!n||!m.usuarioActual)return;m.mesas.length,Object.keys(m.timers).forEach(r=>{m.mesas.find(s=>s.id===parseInt(r))||(clearInterval(m.timers[r]),delete m.timers[r])});const e=Array.from(n.children).map(r=>parseInt(r.id.replace("mesa-",""))),t=m.mesas.map(r=>r.id);e.forEach(r=>{var s;t.includes(r)||(s=document.getElementById(`mesa-${r}`))==null||s.remove()}),m.mesas.forEach(r=>{let s=document.getElementById(`mesa-${r.id}`);!s&&(s=document.createElement("div"),s.id=`mesa-${r.id}`,n.appendChild(s));const a=`mesa-card ${r.ocupada?"mesa-ocupada":"mesa-disponible"}`;s.className!==a&&(s.className=a);const u=`
    ...
    `;s.innerHTML!==u&&(s.innerHTML=u),r.ocupada&&r.inicio?(r.tiempoTranscurrido=Math.floor((Date.now()-r.inicio)/1e3),Jl(r.id),m.timers[r.id]||(m.timers[r.id]=setInterval(()=>Jl(r.id),1e3))):m.timers[r.id]&&(clearInterval(m.timers[r.id]),delete m.timers[r.id])})}async function aw(n){const e=m.mesas.find(t=>t.id===n);if(e){if(e.ocupada){const t=Math.floor((Date.now()-e.inicio)/1e3),r=ga(t),s=e.consumos?e.consumos.reduce((a,c)=>a+c.precio*c.cantidad,0):0,i=r.costo+s;if(i<=0){if(!await fe.show("⏹️ Cerrar Mesa",`¿Finalizar Mesa ${n}?
...
No hay cobro (tiempo y consumos mínimos).`,{confirmText:"Cerrar",cancelText:"Cancelar"}))return;await te.finalizarMesa(n,{metodoPago:"Sin cobro",montoEfectivo:0,montoYape:0})}else{const a=await ya.show(i,`Cierre de Mesa Billar ${n}`);if(!a||!a.metodoPago)return;await te.finalizarMesa(n,a)}}else await te.iniciarMesa(n);Qt(),document.dispatchEvent(new CustomEvent("ventas:changed")),document.dispatchEvent(new CustomEvent("caja:changed")),document.dispatchEvent(new CustomEvent("dashboard:changed"))}}function Jt(){const n=document.getElementById("mesasConsumoContainer");!n||!m.usuarioActual||(m.mesasConsumo.length,n.innerHTML="",m.mesasConsumo.forEach(e=>{const t=(m.usuarioActual.rol||"").toLowerCase()==="admin",r=document.createElement("div");r.id=`mesa-consumo-${e.id}`,r.className=`mesa-card ${e.ocupada?"mesa-ocupada":"mesa-disponible"}`,r.innerHTML=`
      ...
      `:""}
    `,n.appendChild(r)}))}async function cw(n){const e=m.mesasConsumo.find(t=>t.id===n);if(e){if(e.ocupada)if(e.total<=0){if(!await fe.show("⏹️ Cerrar Mesa Consumo",`¿Finalizar Mesa Consumo ${n}? No hay consumos registrados.`,{confirmText:"Cerrar",cancelText:"Cancelar"}))return;await te.finalizarMesaConsumo(n,{metodoPago:"Sin cobro",montoEfectivo:0,montoYape:0})}else{const t=await ya.show(e.total,`Cierre de Mesa Consumo ${n}`);if(!t||!t.metodoPago)return;await te.finalizarMesaConsumo(n,t)}else await te.iniciarMesaConsumo(n);Jt(),document.dispatchEvent(new CustomEvent("ventas:changed")),document.dispatchEvent(new CustomEvent("caja:changed")),document.dispatchEvent(new CustomEvent("dashboard:changed"))}}let Dh={mesaId:null,tipo:null};function lw(n,e){Dh={mesaId:n,tipo:e};const t=document.getElementById("modalConsumo");if(!t)return;const r=document.getElementById("modalConsumoTitulo");r&&(r.textContent=e==="billar"?`🎱 Consumos - Mesa Billar ${n}`:`🪑 Consumos - Mesa Consumo ${n}`),bs(),t.classList.add("show")}function bs(){const{mesaId:n,tipo:e}=Dh,t=e==="billar"?m.mesas.find(c=>c.id===n):m.mesasConsumo.find(c=>c.id===n),r=document.getElementById("listaConsumosMesa"),s=document.getElementById("productosConsumoContainer");if(!t)return;const i=t.consumos||[];if(i.length===0)r.innerHTML='<p style="color: #999; text-align: center; padding: 15px;">Sin consumos aún</p>';else{const c=i.reduce((u,d)=>u+d.precio*d.cantidad,0);r.innerHTML=`
      ${i.map(u=>`
    ...
    `}if(!s)return;const a=uw(m.productos);if(a.length===0){s.innerHTML='<p style="color: #999; text-align: center; padding: 20px;">No hay productos disponibles</p>';return}s.innerHTML=a.map(c=>{const u=c.stock>0;return`
    ...
    `}).join("")}function uw(n){const e={Licores:1,Gaseosas:2,Golosinas:3,Otros:4};return[...n].sort((t,r)=>{const s=e[t.categoria]||99,i=e[r.categoria]||99;return s!==i?s-i:t.nombre.localeCompare(r.nombre)})}function dw(){var n;document.addEventListener("click",async e=>{var u,d;const t=(u=e.target.closest("[data-action]"))==null?void 0:u.dataset.action;if(!t)return;const r=e.target.closest("[data-action]"),s=parseInt(r==null?void 0:r.dataset.id),i=r==null?void 0:r.dataset.tipo,a=parseInt(r==null?void 0:r.dataset.productoId),c=parseInt(r==null?void 0:r.dataset.mesaId);switch(t){case"toggle-mesa":await aw(s);break;case"eliminar-mesa":await te.eliminarMesa(s)&&Qt();break;case"toggle-mesa-consumo":await cw(s);break;case"eliminar-mesa-consumo":await te.eliminarMesaConsumo(s)&&Jt();break;case"abrir-consumo":lw(s,i);break;case"agregar-consumo":await te.agregarConsumo(a,c,i)&&(bs(),i==="billar"?Qt():Jt());break;case"eliminar-consumo":await te.eliminarConsumo(a,c,i)&&(bs(),i==="billar"?Qt():Jt());break;case"editar-consumo":{const f=prompt("Ingrese la nueva cantidad:");f!==null&&f.trim()!==""&&await te.editarConsumo(a,c,i,f)&&(bs(),i==="billar"?Qt():Jt());break}case"agregar-mesa":await te.agregarMesa()&&Qt();break;case"agregar-mesa-consumo":await te.agregarMesaConsumo()&&Jt();break;case"close-modal-consumo":(d=document.getElementById("modalConsumo"))==null||d.classList.remove("show");break}}),(n=document.getElementById("modalConsumo"))==null||n.addEventListener("click",e=>{e.target===e.currentTarget&&e.currentTarget.classList.remove("show")})}function qr(){const n=document.getElementById("ventasTable");if(!n)return;if(m.ventas.length===0){n.innerHTML='<tr><td colspan="6" style="text-align: center; padding: 30px; color: #999;">No hay ventas registradas</td></tr>';return}const t=[...m.ventas].reverse().slice(0,m.limiteVentas);n.innerHTML=t.map(r=>{var u;const s=r.metodoPago||"Efectivo",i=s==="Yape"?"#742284":s==="Mixto"?"#0ea5e9":"#10b981",a=s==="Mixto"?`Ef: S/${(r.montoEfectivo||0).toFixed(2)} | Yp: S/${(r.montoYape||0).toFixed(2)}`:s,c=(((u=m.usuarioActual)==null?void 0:u.rol)||"").toLowerCase()==="admin";return`
      <tr>
    ...
    `}).join("")}function pw(){const n=document.getElementById("modalVentaProductos");if(n){_a="";const e=document.getElementById("buscarVentaProducto");e&&(e.value=""),va(),n.classList.add("show")}}function gw(){var n;(n=document.getElementById("modalVentaProductos"))==null||n.classList.remove("show")}async function yw(n){var u;const e=document.getElementById(`btn-vender-${n}`);if(e!=null&&e.disabled)return;e&&(e.disabled=!0,e.textContent="Procesando...");const t=document.getElementById(`qty-${n}`),r=parseInt(t==null?void 0:t.value),s=m.productos.find(d=>d.id===n);if(!s||isNaN(r)||r<=0||r>s.stock){x.error("Cantidad inválida o stock insuficiente"),e&&(e.disabled=!1,e.textContent="Vender");return}const i=s.precio*r,a=((u=document.getElementById("metodoPagoDirecto"))==null?void 0:u.value)||"Efectivo",c={id:Date.now(),tipo:"Venta Directa",tipoDetalle:`${s.nombre} x${r}`,monto:i,metodoPago:a,montoEfectivo:a==="Efectivo"?i:0,montoYape:a==="Yape"?i:0,fecha:new Date().toLocaleString("es-PE"),usuario:m.usuarioActual.nombre,detalle:{consumos:[{producto:s.nombre,cantidad:r,precioUnitario:s.precio,subtotal:i}],totalConsumos:i}};m.ventas.push(c),s.stock-=r,ye.procesarConsumoProducto(n,r,!1).then(d=>{c.ganancia=d,ae(H.VENTAS,Q.TODAS,{lista:m.ventas})}).catch(d=>console.error(d)),va(),qr(),di(),document.dispatchEvent(new CustomEvent("inventario:changed")),document.dispatchEvent(new CustomEvent("dashboard:changed")),document.dispatchEvent(new CustomEvent("caja:changed")),x.success(`✅ Procesando venta de ${r}x ${s.nombre}...`),e&&(e.disabled=!1,e.textContent="Vender")}async function _w(n){var t;if((((t=m.usuarioActual)==null?void 0:t.rol)||"").toLowerCase()!=="admin"){x.error("Solo los administradores pueden eliminar ventas");return}await fe.show("🗑️ Eliminar Venta","¿Estás seguro de eliminar esta venta? Esta acción no se puede deshacer.",{confirmText:"Eliminar",cancelText:"Cancelar",isDestructive:!0})&&(m.ventas=m.ventas.filter(r=>r.id!==n),qr(),di(),x.success("✅ Eliminando venta..."),ae(H.VENTAS,Q.TODAS,{lista:m.ventas},!0).catch(r=>{console.error("Error al eliminar venta:",r),x.error("❌ Error al sincronizar eliminación con la nube")}))}function vw(){var n;document.addEventListener("click",async e=>{var s,i;const t=e.target.closest("[data-action]");switch(t==null?void 0:t.dataset.action){case"eliminar-venta":await _w(parseInt(t.dataset.id));break;case"vender-producto":await yw(parseInt(t.dataset.id));break;case"cargar-mas-ventas":m.limiteVentas+=20,qr();break;case"show-venta-manual":hw();break;case"close-venta-manual":Vh();break;case"guardar-venta-manual":await fw();break;case"show-venta-productos":pw();break;case"close-venta-productos":gw();break;case"show-eliminar-ventas":(s=document.getElementById("modalEliminarVentas"))==null||s.classList.add("show");break;case"close-eliminar-ventas":(i=document.getElementById("modalEliminarVentas"))==null||i.classList.remove("show");break}}),(n=document.getElementById("buscarVentaProducto"))==null||n.addEventListener("input",e=>{_a=e.target.value,va()})}const Ew={Golosinas:"🍬",Gaseosas:"🥤",Licores:"🍺",Otros:"📦"};function ww(n){const e={Licores:1,Gaseosas:2,Golosinas:3,Otros:4};return[...n].sort((t,r)=>{const s=e[t.categoria]||99,i=e[r.categoria]||99;return s!==i?s-i:t.nombre.localeCompare(r.nombre)})}function Ln(){var r;const n=document.getElementById("inventarioGrid");if(!n)return;const e=(((r=m.usuarioActual)==null?void 0:r.rol)||"").toLowerCase()==="admin";let t=[...m.productos];if(m.ordenInventarioActual==="masVendidos"?t.sort((s,i)=>(i.unidadesVendidas||0)-(s.unidadesVendidas||0)):m.ordenInventarioActual==="menosStock"?t.sort((s,i)=>s.stock-i.stock):m.ordenInventarioActual==="categoria"&&(t=ww(t)),t.length===0){n.innerHTML='<p style="grid-column:1/-1;text-align:center;padding:40px;color:#999;">No hay productos en el inventario</p>';return}n.innerHTML=t.map((s,i)=>{const a=s.stock<=s.stockMin,c=s.precioCosto||0,u=s.precio||0,d=u-c,f=c>0?d/u*100:0,g=s.stockInicial||s.stock,w=s.unidadesVendidas||0,C=s.gananciaAcumulada||0,M=d*s.stock,O=C+M,S=g>0?w/g*100:0,P=Ew[s.categoria]||"📦";let F="";if(m.ordenInventarioActual==="categoria"){const q=t[i-1];(!q||q.categoria!==s.categoria)&&(F=`<div style="grid-column:1/-1;margin-top:15px;margin-bottom:5px;border-bottom:2px solid #e5e7eb;padding-bottom:5px;font-weight:bold;color:#4b5563;">${P} ${s.categoria||"Sin Categoría"}</div>`)}return`
      ${F}
...
Las ventas y consumos vuelven a estar activos en el periodo actual. El cierre se borrará permanentemente.`,{confirmText:"Deshacer Cierre",cancelText:"Volver",isDestructive:!0})?(m.cierres=m.cierres.filter(t=>t.id!==n),m.cierres.length>0?m.ultimoCierre=m.cierres[m.cierres.length-1].timestamp:m.ultimoCierre=null,await Qe.saveCierres(!0),x.success("✅ Cierre eliminado. Ventas reactivadas."),!0):!1,descargarReporteCierre:n=>{const e=window.open("","_blank","width=850,height=600");if(!e){x.error("⚠️ El navegador bloqueó la ventana emergente. Por favor habilítalas.");return}e.document.write(`<!DOCTYPE html><html><head><meta charset="UTF-8">
  ...
  `).join("")}function Lw(n,e){const t=document.getElementById("graficaMensualContainer");if(!t)return;const r=Nh.map((i,a)=>{const c=m.ventas.filter(u=>{const d=En(u.fecha||u.id);return d.anio===n&&d.mes===a});return{nombre:i.substring(0,3),total:c.reduce((u,d)=>u+(d.monto||0),0)}}),s=Math.max(...r.map(i=>i.total),1);t.innerHTML=`
  ...
  `).join("")}async function Nw(){var t,r;const n=(t=document.getElementById("errorMensaje"))==null?void 0:t.value.trim();if(!n){x.error("Por favor describe el error");return}const e={id:Date.now(),descripcion:n,fecha:new Date().toLocaleString("es-PE"),usuario:m.usuarioActual.nombre,estado:"pendiente"};m.erroresReportados.push(e),await ae(H.ERRORES,Q.TODOS,{lista:m.erroresReportados}),x.success("✅ Error reportado correctamente. Gracias."),(r=document.getElementById("modalError"))==null||r.classList.remove("show")}async function Ow(n){const e=m.erroresReportados.find(t=>t.id===n);e&&(e.estado=e.estado==="pendiente"?"resuelto":"pendiente",await ae(H.ERRORES,Q.TODOS,{lista:m.erroresReportados}),wa())}async function Fw(n){await fe.show("🗑️ Eliminar Error","¿Estás seguro de eliminar este reporte?",{confirmText:"Eliminar",cancelText:"Cancelar",isDestructive:!0})&&(m.erroresReportados=m.erroresReportados.filter(t=>t.id!==n),await ae(H.ERRORES,Q.TODOS,{lista:m.erroresReportados},!0),wa())}function $w(){document.addEventListener("click",async n=>{var s,i;const e=n.target.closest("[data-action]"),t=e==null?void 0:e.dataset.action,r=parseInt(e==null?void 0:e.dataset.id);switch(t){case"show-modal-error":document.getElementById("errorMensaje")&&(document.getElementById("errorMensaje").value=""),(s=document.getElementById("modalError"))==null||s.classList.add("show");break;case"close-modal-error":(i=document.getElementById("modalError"))==null||i.classList.remove("show");break;case"reportar-error":await Nw();break;case"toggle-error":await Ow(r);break;case"eliminar-error":await Fw(r);break}})}function Ta(){var i;const n=document.getElementById("consumoDuenoContainer");if(!n)return;const e=m.ultimoCierre?m.consumosDueno.filter(a=>a.id>m.ultimoCierre):m.consumosDueno,t=(((i=m.usuarioActual)==null?void 0:i.rol)||"").toLowerCase()==="admin";if(e.length===0){n.innerHTML=`
  ...
  `).join("")}function Uw(){const n=document.getElementById("productosConsumoDuenoGrid");if(!n)return;const e={Licores:1,Gaseosas:2,Golosinas:3,Otros:4},t=[...m.productos].sort((r,s)=>{const i=e[r.categoria]||99,a=e[s.categoria]||99;return i!==a?i-a:r.nombre.localeCompare(s.nombre)});n.innerHTML=t.filter(r=>r.stock>0).map(r=>`
...
<body>
...
</html>`),t.document.close(),setTimeout(()=>t.focus(),250)}function Hw(){document.addEventListener("click",async n=>{var s;const e=n.target.closest("[data-action]"),t=e==null?void 0:e.dataset.action,r=parseInt(e==null?void 0:e.dataset.id);switch(t){case"show-modal-consumo-dueno":Bw();break;case"close-modal-consumo-dueno":(s=document.getElementById("modalConsumoDueno"))==null||s.classList.remove("show");break;case"guardar-consumo-dueno":await jw();break;case"agregar-carrito-dueno":{const i=m.productos.find(c=>c.id===r);if(!i||i.stock<=0){x.error("Sin stock disponible");break}const a=Me.find(c=>c.id===r);if(a)if(a.cantidad<i.stock)a.cantidad++;else{x.warning("No hay más stock disponible");break}else Me.push({id:i.id,nombre:i.nombre,precio:i.precio,cantidad:1});Co();break}case"quitar-carrito-dueno":{const i=Me.findIndex(a=>a.id===r);i!==-1&&(Me[i].cantidad--,Me[i].cantidad<=0&&Me.splice(i,1)),Co();break}case"eliminar-consumo-dueno":await zw(r);break;case"descargar-consumo-pdf":qw();break}})}let Re=null;function Ia(){const n=document.getElementById("usuariosTable");if(n){if(m.usuarios.length===0){n.innerHTML='<tr><td colspan="4" style="text-align:center;padding:30px;color:#999;">No hay usuarios registrados</td></tr>';return}n.innerHTML=m.usuarios.map(e=>{var t;return`
    <tr>
      <td>${e.username}</td>
      <td>${e.nombre}</td>
      <td style="text-align:center;">
  ...
  `}async function eu(n){if(m.tabActual===n)return;m.tabActual=n,document.querySelectorAll(".tab").forEach(s=>{const i=s.dataset.tab===n;s.classList.toggle("active",i)});let e=null;document.querySelectorAll(".tab-content").forEach(s=>{const i=s.id.replace("tab","").toLowerCase(),a=n.toLowerCase(),c=i===a||s.id===`tab${Zw(n)}`;s.classList.toggle("active",c),c&&(e=s)});const t=Qw[n];if(!t)return;if(Jw.has(n)&&!m.modulosCargados[n]){e&&Xw(e);try{await WE(n)}catch(s){console.error(`Error cargando datos del módulo ${n}:`,s),e&&(e.innerHTML=`
        ...
        `);return}}try{t()}catch(s){console.error(`Error rendering tab ${n}:`,s)}}function Zw(n){return n.charAt(0).toUpperCase()+n.slice(1)}function eT(){document.addEventListener("click",e=>{const t=e.target.closest("[data-tab]");if(!t)return;const r=t.dataset.tab;r&&eu(r)});const n=m.tabActual||"mesas";eu(n)}function tT(){document.addEventListener("click",async n=>{var r,s;const e=n.target.closest("[data-action]");if((e==null?void 0:e.dataset.action)==="guardar-configuracion"){const i=parseFloat((r=document.getElementById("tarifaHora"))==null?void 0:r.value),a=parseFloat((s=document.getElementById("tarifaExtra5Min"))==null?void 0:s.value);if(isNaN(i)||isNaN(a)){x.error("Por favor ingresa valores válidos");return}m.config.tarifaHora=i,m.config.tarifaExtra5Min=a,await ae(H.CONFIGURACION,Q.GENERAL,{tarifaHora:i,tarifaExtra5Min:a},!0),x.success("✅ Configuración guardada correctamente")}if(n.target.closest(".close-btn")||n.target.closest(".btn-gray")&&n.target.closest(".btn-gray").textContent.trim().toLowerCase()==="cancelar"){const i=n.target.closest(".modal");i&&i.classList.remove("show")}})}function nT(){eT()}async function tu(){rw(),nw(),dw(),vw(),Cw(),Dw(),Mw(),$w(),Hw(),Yw(),tT(),await tw(nT)}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",tu):tu();
